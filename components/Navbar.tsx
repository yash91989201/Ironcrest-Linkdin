        ...
        <div className="flex items-center h-full">
             ...
             {navItems.map((item, idx) => (
                 <li 
                   ...
                   onClick={(e) => e.preventDefault()}
                    className={`flex flex-col items-center justify-center cursor-pointer min-w-[60px] h-full border-b-2 border-transparent text-gray-500 hover:text-black transition-colors`}
                 >
            ...
            {/* Auth Buttons */}
             <div className="flex items-center gap-3">
                 <button onClick={(e) => e.preventDefault()} className="hidden sm:block px-6 py-2.5 rounded-full text-base font-semibold text-linkedin-blue hover:bg-blue-50 hover:shadow-[inset_0_0_0_1px_#0a66c2] transition-all border border-transparent text-center decoration-0">
                     Sign in
                 </button>
